...
test('discovery category fallback preserves original requirements and marks alternatives',async()=>{
  ...
  assert.equal(result.candidates.length,1);assert.match(result.candidates[0].discoveryNote,/not the requested LCD/);
